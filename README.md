<img width="717" height="451" alt="image" src="https://github.com/user-attachments/assets/02d636ef-9f99-4740-8351-2da0b40ec45c" />

# Litematica Printer Addon

AUTISM Client addon that prints whatever schematic is loaded in **Litematica** - no file picking,
no paths. It watches Litematica's schematic hologram and places every block it can reach.
